            ...
            <div class="col">
                <div class="card">
                    <div class="card-header">
                        <h3>Marcar los articulos que desea ingresar a un depósito</h3>
                    </div>
                    <div class="card-body">
                        <div class="row">
                        <div class="form-group col-md-6">
                            <label for="inputState">Elige el pañol a ingresar los artículos</label>
        ...
        success: function (data) {
            ...
            $('input[id="article-check"]').click(function () { 
                ...
                if (validator <= 0) {
                    ...
                    window.location.href ='../views/confirm_input.php';
                });
                }
            });
        }
