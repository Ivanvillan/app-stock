                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <button id="addStock" class="btn btn-primary float-right" onClick="confirmOutput()">Enviar</button>
                            </div>
                        </div>
                    </div>
            ...
            $.ajax({
              ...
              success: function(data, textStatus, xhr) {
                ...
                $("#success-alert").fadeTo(2000, 500).slideUp(500, function(){
                    ...
                    window.location.href ='../views/output_stock.php';
                });
              },
              error: function(xhr, textStatus, errorThrown) {
                    $('#danger-alert').addClass('alert alert-danger')
                        .add('span')
                        .text('Error al enviar stock con precio');
        ...
        $.ajax({
            ...
            success: function (response) {
                console.log(response.result);
                    ...
                    <td> ${stock} </td>
                    <td> <input type="number" max="${response.result[0].existencia}" min="1" name="cant[]" value="" class="form-control cant" placeholder="Cant."> </td>
                    <td> <input type="text" name="observation[]" class="form-control observation" placeholder="Observacion"> </td> 
