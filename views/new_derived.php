...
<head>
    ...
    <title>Derivación de artículo</title>
</head>
<body>
...
<div class="container">
    <div class="card">
        ...
        <h4 class="card-title">Completa los datos para crear un movimiento de artículo</h4>
        <div class="row">
            <div class="col col-md-3 form-group">
                <strong><label for="">Nombre</label></strong>
                <br>
                <span class="article_name">Nombre</span>
            </div>
            <div class="col col-md-3 form-group">
                <strong><label for="">Marca</label></strong>
                <br>
                <span class="article_mark">Marca</span>
            </div>
            <div class="col col-md-3 form-group">
                <strong><label for="">Detalle</label></strong>
                <br>
                <span class="article_detail">Detalle</span>
            </div>
            <div class="col col-md-3 form-group">
        ...
        <div class="row">
            <div class="col col-md-4 form-group">
                ...
                <br>
                <span class="article_exist">Cantidad</span>
            </div>
            <div class="col col-md-4 form-group">
        ...
        <div class="row">
            <div class="col form-group">
                <button id="sendDelivered" class="btn btn-primary float-right">Enviar</button>
            </div>
        </div>
        </div>
    </div>
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data.result[0].existencia <= 0) {
                $('#sendDelivered').prop('disabled', true);
            }
        }
    });
    if (userprofile != 1) {
        ...
        $('#sendDelivered').click(function (e) { 
            e.preventDefault();
            var url = '/api-stock/public/index.php/movements/insert/' + selectedDepots + '/' + typeArticle + 'delivered';
            var data = {
                id: idElement,
